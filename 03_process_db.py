...
# Percentage of total tracks that a genre makes up. Based on original # My Radio # playlist
...
#   be read pack so we can create the m3u file with songs that match the genre
# 
# 
# # # # # # # # # # # # # # # # # #
