...
print("Total",genres[0],"songs - ",nbr_of_genre_songs[0])
print("Total",genres[1],"songs - ",nbr_of_genre_songs[1])
print("Total",genres[2],"songs - ",nbr_of_genre_songs[2])
print("Total",genres[3],"songs - ",nbr_of_genre_songs[3])
print("Total",genres[4],"songs - ",nbr_of_genre_songs[4])
